      ...
      <main className="flex-1">
        ...
        <section className="relative">
          <div className="absolute inset-0">
            <Image
              src="/placeholder.svg?height=1080&width=1920&text=Ballena+Jorobada"
        ...
        <section id="about" className="py-16 md:py-24 bg-white">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">¿Qué es Safari La Ventana?</h2>
              <p className="text-lg text-gray-700 leading-relaxed">
                Zarpamos desde La Ventana hacia el azul profundo. Guiados por biólogos marinos, navegamos para encontrar
                móbulas, delfines, ballenas y sorpresas naturales. No es un show, es naturaleza real. No garantizamos
                encuentros, garantizamos autenticidad.
              </p>
            </div>
        ...
        <section id="wildlife" className="py-16 md:py-24 bg-white">
          <div className="container mx-auto px-4">
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto text-center mb-16">
              El Mar de Cortés es uno de los mares más biodiversos del planeta. Estas son algunas de las especies que
              podrías avistar durante tu safari.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-teal-50 rounded-lg overflow-hidden">
                <div className="h-64 relative">
                  <Image
                    src="/placeholder.svg?height=400&width=600&text=Ballena+Azul"
                    alt="Ballena Azul"
                    width={600}
                    height={400}
                    className="w-full h-full object-cover"
                ...
                <div className="p-6">
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">Ballena Azul</h3>
                  <p className="text-gray-700">
                    El animal más grande del planeta. Avistar una ballena azul es una experiencia extraordinaria y
                    transformadora.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-teal-50 rounded-lg overflow-hidden">
                <div className="h-64 relative">
                  <Image
                    src="/placeholder.svg?height=400&width=600&text=Ballena+Gris"
                    alt="Ballena Gris"
                    width={600}
                    height={400}
                    className="w-full h-full object-cover"
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-700">
                    Famosas por su curiosidad y comportamiento amistoso. Las ballenas grises realizan una de las
                    migraciones más largas de cualquier mamífero.
                  </p>
                </div>
              </div>
            ...
            <div className="mt-12 bg-teal-50 p-6 rounded-lg border border-teal-100 max-w-3xl mx-auto">
              ...
              <p className="text-gray-700 text-center">
                Trabajamos con vida salvaje libre. No podemos garantizar avistamientos, pero sí te prometemos respeto,
                experiencia y momentos inolvidables.
              </p>
            </div>
          </div>
        </section>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              <div className="flex items-center gap-2 mb-4">
                <Image
                  ...
                  className="rounded-full"
                />
                <span className="text-xl font-medium">Safari La Ventana</span>
              </div>
              <p className="text-gray-400 mb-4">
                Expediciones marinas respetuosas con la naturaleza en La Ventana, Baja California Sur. Descubre la magia
                del Golfo de California con guías expertos y apasionados.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400">
                <li className="flex items-start gap-3">
                  ...
                  <span>Playa Central, La Ventana, BCS, México</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span>info@safarilaventana.com</span>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li>
                  <a href="#wildlife" className="hover:text-white transition-colors">
                    Vida Marina
                  </a>
                </li>
                <li>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-500 text-sm">
            <p>&copy; {new Date().getFullYear()} Safari La Ventana. Todos los derechos reservados.</p>
          </div>
        </div>
      </footer>
    </div>
